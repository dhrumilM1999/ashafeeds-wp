...
<section id="contact-info">
  <div class="row m-0">
    <div class="call col-lg-4 col-md-4 align-self-md-center p-4">
      <?php if( get_theme_mod( 'ashafeeds_call' ) != '' || get_theme_mod('ashafeeds_call_text','') ) { ?>
        <div class="row">
          ...
          <div class="col-lg-9 col-md-9 align-self-md-center">
            ...
            <p class="simplep mb-0"><?php echo esc_html( get_theme_mod('ashafeeds_call','') ); ?></p>
          </div>
        </div>
      <?php } ?>
    </div>
    <div class="email col-lg-4 col-md-4 align-self-md-center p-4">
      <?php if( get_theme_mod( 'ashafeeds_mail' ) != '' || get_theme_mod('ashafeeds_mail_text','') ) { ?>
        <div class="row">
          ...
          <div class="col-lg-9 col-md-9 align-self-md-center">
            ...
            <p class="simplep mb-0"><?php echo esc_html( get_theme_mod('ashafeeds_mail','') ); ?></p>
          </div>
        </div>
      <?php } ?>
    </div>
