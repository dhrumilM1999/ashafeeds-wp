  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-12 align-self-md-center">
        ...
        if($ashafeeds_logo_settings == 'Different Line'){ ?>
          <div class="logo">
            ...
            <?php }?>
            <?php $ashafeeds_description = get_bloginfo( 'description', 'display' );
            if ( $ashafeeds_description || is_customize_preview() ) : ?>
              <?php if(get_theme_mod('ashafeeds_site_tagline','') != ''){ ?>
                <p class="site-description"><?php echo esc_html($ashafeeds_description); ?></p>
              <?php }?>
            <?php endif; ?>
          </div>
      ...
      <div class="call col-lg-3 col-md-4 align-self-md-center">
        <?php if( get_theme_mod( 'ashafeeds_call_text' ) != '' || get_theme_mod( 'ashafeeds_call' ) != '') { ?>
          <div class="row">
            <div class="col-lg-3 col-md-3"><i class="fas fa-phone"></i></div>
            <div class="col-lg-9 col-md-9">
              <p class="infotext"><?php echo esc_html( get_theme_mod('ashafeeds_call_text','') ); ?></p>
              <p class="simplep"><?php echo esc_html( get_theme_mod('ashafeeds_call','') ); ?></p>
            </div>
          </div>
        <?php } ?>
      </div>
      <div class="email col-lg-3 col-md-4 align-self-md-center">
        <?php if( get_theme_mod( 'ashafeeds_mail_text' ) != '' || get_theme_mod( 'ashafeeds_mail' ) != '') { ?>
          <div class="row">
            <div class="col-lg-3 col-md-3"><i class="fas fa-envelope-open"></i></div>
            <div class="col-lg-9 col-md-9">
              <p class="infotext"><?php echo esc_html( get_theme_mod('ashafeeds_mail_text','')); ?></p>
              <p class="simplep"><?php echo esc_html( get_theme_mod('ashafeeds_mail','') ); ?></p>
            </div>
          </div>
        <?php } ?>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
              <p class="cart_no infotext">
                ...
                <a href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'shopping cart','ashafeeds' ); ?>"><?php esc_html_e('CART ITEM','ashafeeds'); ?></a>
              </p>
