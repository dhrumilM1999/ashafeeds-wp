...
function ashafeeds_setup() {
	 ...
	 * specifically font, colors, and column width.
 	 */
	add_editor_style( array( 'assets/css/editor-style.css', ashafeeds_fonts_url() ) );
}
 ...
 */
function ashafeeds_fonts_url(){
	$ashafeeds_font_url = '';
	$ashafeeds_font_family = array();
	$ashafeeds_font_family[] = 'Oswald:200,300,400,500,600,700';
	$ashafeeds_font_family[] = 'Roboto:100,100i,300,400,400i,500,500i,700,700i,900,900i';
	$ashafeeds_font_family[] = 'Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900';

	$ashafeeds_query_args = array(
		'family'	=> rawurlencode(implode('|',$ashafeeds_font_family)),
	);
	$ashafeeds_font_url = add_query_arg($ashafeeds_query_args,'//fonts.googleapis.com/css');
	return $ashafeeds_font_url;
	$contents = wptt_get_webfont_url( esc_url_raw( $ashafeeds_font_url ) );
}
...
function ashafeeds_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog Sidebar', 'ashafeeds' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'ashafeeds' ),
	...
	register_sidebar( array(
		'name'          => __( 'Page Sidebar', 'ashafeeds' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Add widgets here to appear in your sidebar on pages.', 'ashafeeds' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 1', 'ashafeeds' ),
		'id'            => 'footer-1',
		'description'   => __( 'Add widgets here to appear in your footer.', 'ashafeeds' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
function ashafeeds_scripts() {
	...
	wp_enqueue_style( 'ashafeeds-fonts', ashafeeds_fonts_url(), array(), null );
	...
	if(!wp_is_mobile()){
		...
		wp_enqueue_script( 'ashafeeds-superfish-custom-scripts', esc_url( get_template_directory_uri() ) . '/assets/js/ashafeeds-superfish-custom.js', array('jquery','jquery-superfish'), true );
	}
...
define('ashafeeds_CREDIT',__('https://www.themespride.com/themes/free-automobile-wordpress-theme/','ashafeeds') );
if ( ! function_exists( 'ashafeeds_credit' ) ) {
	function ashafeeds_credit(){
		echo "<a href=".esc_url(ashafeeds_CREDIT)." target='_blank'>".esc_html__('Automobile WordPress Theme','ashafeeds')."</a>";
	}
}

function ashafeeds_activation_notice() { ?>
    <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
        <div class="ashafeeds-getting-started-notice clearfix">
            <div class="ashafeeds-theme-notice-content">
                <h2 class="ashafeeds-notice-h2">
                    <?php
                printf(
                /* translators: 1: welcome page link starting html tag, 2: welcome page link ending html tag. */
                    esc_html__( 'Welcome! Thank you for choosing %1$s!', 'ashafeeds' ), '<strong>'. wp_get_theme()->get('Name'). '</strong>' );
                ?>
                </h2>

                <p class="plugin-install-notice"><?php echo sprintf(__('Click here to get started with the theme set-up.', 'ashafeeds')) ?></p>

                <a class="ashafeeds-btn-get-started button button-primary button-hero ashafeeds-button-padding" href="<?php echo esc_url( admin_url( 'themes.php?page=ashafeeds-about' )); ?>" ><?php esc_html_e( 'Get started', 'ashafeeds' ) ?></a><span class="ashafeeds-push-down">
                <?php
...
add_action( 'admin_notices', 'ashafeeds_activation_notice' );
