	...
	<tbody>
				...
				<table class="form-table hbupro-bgcolor" <?php echo $banner_bgcolor_style; ?>>
					...
					<tr class="hbupro-feature">
						...
						<td>
							...
							<span class="description"><?php esc_html_e('Select background color type.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
					...
					<tr class="hbupro-feature">	
						...
						<td>
							...
							<span class="description"><?php esc_html_e('Gradient Color Position. This option works in background color option Gradient Color.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
				</table>
				...
				<table class="form-table hbupro-video" <?php echo $banner_video_style;?>>
					...
					<tr class="hbupro-feature">
						...
						<td class="row-meta">
							...
							<span class="description"><?php esc_html_e('Upload Video Poster image.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
		...
		<tr class="hbupro-feature">
			...
			<td>
				...
				<span class="description"><?php esc_html_e('Check to Display Title Text on UPPERCASE', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		<!-- SubTitle Size -->
		<tr valign="top">
		...
		<tr class="hbupro-feature">
			...
			<td>
				<input type="checkbox" name="<?php echo esc_attr($prefix);?>banner_title_upper" value="Title Uppercase" disabled="" /><br />
				<span class="description"><?php esc_html_e('Check to Display Subtitle Text on UPPERCASE', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		...
		<tr class="hbupro-feature">
			...
			<td>
				...
				<span class="description"><?php esc_html_e('Enter title font size in PX', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		...
		<tr class="hbupro-feature">
			...
			<td>
				...
				<span class="description"><?php esc_html_e('Enter sub title font size in PX', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		...
		<tr class="hbupro-feature">
			...
			<td class="row-meta">
				...
				<br/>
				<span class="description"><?php esc_html_e('Select bacground image size for mobile.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
